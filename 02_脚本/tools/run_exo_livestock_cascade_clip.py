#!/usr/bin/env python3
"""CLI: exo_livestock CLIP 渔业牧业劳作零样本（本地）。"""
...
_DEFAULT_CFG = (
    _SCRIPT / "categories" / "exo_livestock" / "rules" / "cascade_livestock_clip.toml"
)


def main() -> int:
    ap = argparse.ArgumentParser(description="exo_livestock CLIP fishing/herding filter")
