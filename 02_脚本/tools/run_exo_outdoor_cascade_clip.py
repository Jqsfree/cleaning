#!/usr/bin/env python3
"""CLI: exo_outdoor CLIP 户外场景零样本（本地）。"""
...
_DEFAULT_CFG = (
    _SCRIPT / "categories" / "exo_outdoor" / "rules" / "cascade_outdoor_clip.toml"
)


def main() -> int:
    ap = argparse.ArgumentParser(description="exo_outdoor CLIP outdoor scene filter")
