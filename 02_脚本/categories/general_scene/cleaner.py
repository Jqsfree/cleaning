#!/usr/bin/env python3
"""categories/general_scene/cleaner.py — 通用场景文本黑名单（certain-noise）。
...
def clean(
    ...
    **kwargs,
    ...
    log("general_scene 文本黑名单清洗（certain-noise）...")
    ...
    summary = {
        "engine": "general_scene-blacklist",
