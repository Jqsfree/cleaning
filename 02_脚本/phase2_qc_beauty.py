#!/usr/bin/env python3
"""
phase2_qc_beauty.py -- SOP Phase 2: LLM 文本质检入口 (美妆版)

这是 chunk_text_qc_beauty.py 的薄封装，为美妆类 SOP Phase 2 提供专用入口。
实际 QC 逻辑在 chunk_text_qc_beauty.run_text_qc() 中。

用法:
  python3 phase2_qc_beauty.py audit_sample_v1.parquet -o data/runs/002_audit/ -w 20
  python3 phase2_qc_beauty.py audit_sample_v1.parquet -o data/runs/002_audit/ -w 20 --force
"""
...
from chunk_text_qc_beauty import run_text_qc, DEFAULT_MODEL, DEFAULT_WORKERS
